...
export default function AIAssistant() {
  ...
  const handleSend = async () => {
    ...
    const fullPrompt = `
      ...
      7. اذا ظهر خطاء عند اتصال مثل خطاء فى ارسال دعوة فهذا خطاء ليسه من حساب شخص او من تطبيق هذا خطاء من سيرفر اخبر شخص الذي يسئل ان هذا عطل يحصل لى معظم ناس بي سبب ان اشخاص كثيرين فى تطبيق و سيرفر لا يستحمل اطلب منه ان يتابع مطور على فيسبوك لانه ينشرا هناك سبب تعطل تطبيق او اي تحديث حاصل حاول ان تبسط الامر لى مستخدمين لكي يفهموا جيدا  اذا سئلك عن حساب مطور على فيسبوك اخبره ان يضغط على علم السودان سوف تظهر له معلومات تطبيق و اسم مطور اخبره ان يضغط على اسم مطور لكي ينقله الى صفحة مطور على فيسبوك
